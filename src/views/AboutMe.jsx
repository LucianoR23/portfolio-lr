    ...
    return (
        <PortfolioLayout>
            <Grid container direction='column' alignItems='center' justifyContent='center' sx={{ height: '100%', width: '100%', justifyContent: { md: 'center' } }}>
                ...
                <Grid item sx={{ height: { md: '80%', xs: '30%'}, width: { md: '50%', xs: '100%'}, mt: { xs: 15, md: 0 } }} display='flex' justifyContent='center' alignItems='center' >
                    <Paper sx={{ width: '70%', height: { md: '55%', xs: '180%'}, backgroundColor: 'background.default', padding: 4, borderRadius: 12, opacity: 0.9 }}  >
